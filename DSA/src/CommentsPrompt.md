I'll add detailed comments to the selected code block including the LeetCode problem details and complexity analysis for each part of the algorithm. DOn't make any changes to the code.
